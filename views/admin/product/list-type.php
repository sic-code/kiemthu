...
<div id="pagination">
    <?php if ($pageNum >= 2) { ?>
    <a href="<?= ROOT_URL . "admin/product?id=$id&page=1" ?>"><i class="fa-solid fa-chevrons-left"></i></a>
    <?php } ?>
    <?php if ($pagePrev >= 1) { ?>
    <a href="<?= ROOT_URL . "admin/product?id=$id&page=$pagePrev" ?>"><i class="fa-solid fa-chevron-left"></i></a>
    <?php } ?>
    ...
    ?>
    <a href="<?= ROOT_URL . "admin/product?id=$id&page=$i" ?>"><?= $i ?></a>
    <?php } ?>
    <!-- sử lý số lượng page  -->

    <?php if ($pageNext < $page_total) { ?>
    <a href="<?= ROOT_URL . "admin/product?id=$id&page=$pageNext" ?>"><i class="fa-solid fa-chevron-right"></i></a>
    <?php } ?>
    <?php if ($pageNum < $page_total) { ?>
    <a href="<?= ROOT_URL . "admin/product?id=$id&page=$page_total" ?>"><i class="fa-solid fa-chevrons-right"></i></a>
    <?php } ?>
</div>
        ...
        <div class="row gx-lg-5 align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0" style="z-index: 10">
                ...
                <p class="opacity-70" style="color: hsl(218, 81%, 85%)">
                    Đăng nhập tài khoản để có thể trải ngiệm mua sắm tốt nhất. Có cơ hội trúng được nhiều phần quà hấp
                    dẫn từ chúng tôi!!!
                </p>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <input type="password" name="password" class="form-control"
                                        value="<?= get_cookie('password') ?>" />
                                </div>

                                <div class="check-box mb-3 d-flex justify-content-between">
                                    <div class="">
                                        <input name="remember" type="checkbox">
                                        <label>Ghi nhớ tài khoản</label>
                                    </div>
                                    <a class="text-nowrap ms-3" href="<?= ROOT_URL . 'register' ?>">Bạn chưa có tài
                                        khoản?</a>
                                </div>
                                <!-- status -->

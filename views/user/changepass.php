    ...
    <div class="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
        <div class="row gx-lg-5 align-items-center">
            <div class="changepass-info col-lg-6 mb-5 mb-lg-0 text-center" style="z-index: 10">
                <img src="https://haycafe.vn/wp-content/uploads/2022/01/Avatar-cute-chibi-nu-dang-yeu.jpg" width="200px" alt="">
                ...
                <div class="card bg-glass">
                    <div class="card-body py-5 px-md-5">
                        ...
                        <form action="changepass_" method="post">
                            <h3 class="mb-4 text-center text-uppercase">Đổi mật khẩu</h3>
                            <div class="form-outline mb-4">
                                <label class="form-label">Email</label>
                                <input type="email" name="change_email" class="form-control" disabled value="<?= $_SESSION['user']['email'] ?>" />
                            </div>
                            <div class="form-outline mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        ...
                                        <input type="password" name="new_password_rp" class="form-control" />
                                    </div>
                                </div>
                            </div>
                            <!-- status form -->
                        ...
                        <div class="card-back text-center">
                            <a href="<?= ROOT_URL ?>"><i class="fa-sharp fa-solid fa-arrow-left me-2"></i>Trởi về trang chủ</a>
                        </div>
                    </div>
                </div>
            </div>
